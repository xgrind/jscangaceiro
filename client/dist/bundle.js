...
let Negociacao = class Negociacao {
    constructor(_data = __WEBPACK_IMPORTED_MODULE_0__util_index_js__["g" /* obrigatorio */]('data'), _quantidade = __WEBPACK_IMPORTED_MODULE_0__util_index_js__["g" /* obrigatorio */]('quantidade'), _valor = __WEBPACK_IMPORTED_MODULE_0__util_index_js__["g" /* obrigatorio */]('valor')) {
        ...
        this._data = new Date(_data.getTime()), Object.freeze(this);
    }
...
let HttpService = class HttpService {
    ...
    get(url) {
        ...
        return fetch(url).then(res => this._handleErrors(resk)).then(res => res.json());
        ;
    }
};
...
let NegociacaoController = (_dec = __WEBPACK_IMPORTED_MODULE_2__util_index_js__["c" /* controller */]('#data', '#quantidade', '#valor'), _dec2 = __WEBPACK_IMPORTED_MODULE_2__util_index_js__["b" /* bindEvent */]('submit', '.form'), _dec3 = __WEBPACK_IMPORTED_MODULE_2__util_index_js__["d" /* debounce */](), _dec4 = __WEBPACK_IMPORTED_MODULE_2__util_index_js__["b" /* bindEvent */]('click', '#botao-apaga'), _dec5 = __WEBPACK_IMPORTED_MODULE_2__util_index_js__["b" /* bindEvent */]('click', '#botao-importa'), _dec(_class = (_class2 = class NegociacaoController {
    ...
    importaNegociacoes() {
        ...
        return _asyncToGenerator(function* () {
            try {
                const negociacoes = yield _this4._service.obemNegociacoesDoPeriodo();
